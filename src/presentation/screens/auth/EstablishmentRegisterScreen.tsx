...
export const EstablishmentRegisterScreen = ({ route, navigation }: Props) => {
  ...
  //   event: DateTimePickerEvent | undefined, // O simplemente eliminarlo si no lo necesitas
  //   selectedDate: Date | undefined,
  //   field: 'opening_time' | 'closing_time'
  // ) => {
  //   const currentDate = selectedDate || new Date();
  
  //   // Dependiendo del picker que se activó, cierra el picker adecuado
  ...
  //   let formattedTime = currentDate.toTimeString().split(' ')[0]; // Formato HH:MM:SS
  //   setForm({ ...form, [field]: formattedTime });
  // };
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          ...
          <Layout style={[styles.fondoPrincipal, { marginTop: 20 }]}>
            <Input
              ...
              accessoryLeft={<MyIcon name="briefcase-outline" />}
            ...
            <Input
              placeholder="Latitud"
              accessoryLeft={<MyIcon name="compass-outline" />}
              value={form.latitude}
